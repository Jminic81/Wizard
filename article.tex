...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in wordcloud(word\_freq\$word, word\_freq\$count, min.freq = 20, colors = brewer.pal(4, : object 'word\_freq' not found}}\end{kframe}
\end{knitrout}
